...
const signupController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            ...
            const usuario = new users_1.default('', name, id, work_area, budget, telephone, email, password, false, true);
            usuarioEntidad.addUsuario(usuario);
            //Una vez el usuario si ha sido registrado, enviaremos un correo electrónico
            yield (0, emailSender_1.default)(usuario.getCorreo, 'Bienvenido a Crowdfounder', 'Bienvenido a Crowdfounder, aplicación del TEC donde podrás crear y producir tus futuros proyectos. Muchas gracias por unirte');
